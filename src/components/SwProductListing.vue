...
$col-prod-5: 1 0 $mx-photo-wth-3;
$col-prod-4: 1 0 $mx-photo-wth-3;
$col-prod-3: 1 0 $mx-photo-wth-1;
$col-prod-2: 1 0 $mx-photo-wth-1;
...
::v-deep .sf-product-card {
  overflow: auto;
  max-width: $mx-photo-wth-1 !important;
